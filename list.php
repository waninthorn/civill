...
<head>
    ...
    <nav class="navbar pt-0 pb-0">
        <div class="navbar pt-0 pb-0">
            <img src="assets/img/nav.png" object-fit="cover" height="65px" alt="nav-logo"
                class="d-inline-block align-text-top">
            <span class="nav-title">Clicknext Conference</span>
        </div>
        <form class="d-flex justify-content-end">
            <div class="me-3 mt-2">
                <span class="name-user">คุณนวรัตน์</span><br>
                <span class="name-position ms-4">อัยการ</span>
            </div>
            <img src="assets/img/user.png" alt="user" object-fit="cover" height="50" class="d-inline-block mt-1 me-3">
        </form>
...
<body style=" grid-template-columns: 1fr;">
    <div class="container-fluid m-0 p-0">
        <div class="list-frame ">
            <div class="bg-left2">
                <img src="assets/img/bg_left2.svg" alt="bg-left" />
            </div>
            <div class="list mt-5 ">
    ...
    <div>
        <img class="img-question" src="assets/img/question.svg" alt="bg-question" />
        <img class="bg-right2" src="assets/img/bg_right2.svg" alt="bg-right" />
